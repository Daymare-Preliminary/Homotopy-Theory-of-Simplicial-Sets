...
\begin{defi}
    ...
    \end{tikzcd}
    \]
    \todo{what is the map $\Delta^n$ supposed to be}
\end{defi}
...
\begin{proof}
    ...
    \todo{alot of work, to do after exam maybe}
...
\todo{still remains with images above}
